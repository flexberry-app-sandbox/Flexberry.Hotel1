...
namespace IIS.Hotel
{
    ...
    [View("СотрудникE", new string[] {
            "КодCотрудника as \'Код cотрудника\'",
            "Имя as \'Имя\'",
            "Фамилия as \'Фамилия\'",
    ...
    public class Сотрудник : ICSSoft.STORMNET.DataObject
    {
        ...
        /// КодCотрудника.
        /// </summary>
        // *** Start programmer edit section *** (Сотрудник.КодCотрудника CustomAttributes)

        // *** End programmer edit section *** (Сотрудник.КодCотрудника CustomAttributes)
        public virtual int КодCотрудника
        {
            get
            {
                // *** Start programmer edit section *** (Сотрудник.КодCотрудника Get start)

                // *** End programmer edit section *** (Сотрудник.КодCотрудника Get start)
                int result = this.fКодCотрудника;
                // *** Start programmer edit section *** (Сотрудник.КодCотрудника Get end)

                // *** End programmer edit section *** (Сотрудник.КодCотрудника Get end)
                return result;
            }
            set
            {
                // *** Start programmer edit section *** (Сотрудник.КодCотрудника Set start)

                // *** End programmer edit section *** (Сотрудник.КодCотрудника Set start)
                this.fКодCотрудника = value;
                // *** Start programmer edit section *** (Сотрудник.КодCотрудника Set end)

                // *** End programmer edit section *** (Сотрудник.КодCотрудника Set end)
            }
        }
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View СотрудникE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СотрудникE", typeof(IIS.Hotel.Сотрудник));
                }
            }
            ...
            public static ICSSoft.STORMNET.View СотрудникL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СотрудникL", typeof(IIS.Hotel.Сотрудник));
                }
            }
        }
    }
